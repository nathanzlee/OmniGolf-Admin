            ...
            <table className="w-full min-w-[780px] border-collapse">
              <thead>
                <tr className="bg-zinc-50">
                  <th className="border-b border-zinc-200 px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-600">Session</th>
                  <th className="border-b border-zinc-200 px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-600">Course</th>
                  <th className="border-b border-zinc-200 px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-600">Date</th>
                  <th className="border-b border-zinc-200 px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-600">Status</th>
                  <th className="border-b border-zinc-200 px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-600">Actions</th>
                </tr>
              </thead>
              <tbody>
                {sessions.length === 0 ? (
                  ...
                  sessions.map((s: any) => (
                    <tr key={s.id} className="hover:bg-zinc-50">
                      ...
                      <td className="border-b border-zinc-100 px-4 py-3 text-sm text-zinc-600">
                        {Array.isArray(s.golf_courses) ? s.golf_courses[0]?.name ?? "—" : s.golf_courses?.name ?? "—"}
                      </td>
